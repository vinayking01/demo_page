        ...
        // primaryColor: Colors.green,
          ...
          appBarTheme: AppBarTheme( // by using this we have not to change in every page of same app in the appvar
              textTheme: ThemeData
                  .light()
                  .textTheme
                  .copyWith( // copying the theme to every page connected
...
class TrackingState extends State<Tracking> {
  ...
  void delete_transactions(String id) {
    setState(() {
      my_transaction_list.removeWhere((tx)=>tx.id == id);
      });
    }
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ourtransactions_list(my_transaction_list, delete_transactions),
            ],
          ),
        ),
